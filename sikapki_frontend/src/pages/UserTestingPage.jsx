    ...
    <section className="ministry-grid mx-auto max-w-4xl px-4 py-10">
      {result ? <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8 text-center shadow-soft">
        ...
        <div className="mt-7 grid gap-5 sm:grid-cols-2">
          ...
          <Select label="Layanan yang diuji" value={form.layanan} onChange={(v) => change('layanan', v)} options={[['keseluruhan','Keseluruhan portal'],['chatbot','Chatbot Helpdesk KI'],['cek_merek','Penelusuran awal merek'],['checklist','Checklist dokumen'],['informasi','Pusat informasi']]} />
        </div>
